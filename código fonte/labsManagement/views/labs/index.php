            ...
            <div class="content">
                ...
                <div class="card mb-3" style="padding-top: 2em; padding-bottom: 1em">
                    <div id="dashboard-actions" class="pl-4 mb-4">
                        <a href="manageLab.php?id=0"><button class="btn btn-success btn-sm" data-toggle="modal" data-target="#create_lab" type="button"><span class="fas fa-plus" data-fa-transform="shrink-3 down-2"></span><span class="d-none d-sm-inline-block ml-1">Novo Laboratório</span></button></a>
                    </div>
...
<script>
    $("#table").load("/tfg/labsManagement/views/labs/tableLabs.php")
</script>